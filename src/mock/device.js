  ...
  'list|100': [
    {
      ...
      address: '@county(true)',
      type: '类型' + '@integer(1, 5)',
      basicProperty1: '设备规格：' + '@integer(10,3000)' + '*' + '@integer(10,3000)' + '*' + '@integer(10,3000)' + ' (cm)',
      basicProperty2: '设备功率：' + '@integer(100,3000)' + '(W)',
      'ownProperty1|1': ['设备气压值：' + '@integer(100,3000)' + ' (Pa)', '设备水压值：' + '@integer(100,3000)' + ' (Pa)'],
      'ownProperty2|1': ['设备故障频率：' + '@integer(0,10)' + '次/年', '设备最高耐温：' + '@integer(60,300)' + ' (℃)'],
      'position|1': [
        { x: "106.55", y: "29.57" },
        { x: "106.45", y: "29.97" },
        { x: "106.75", y: "29.67" },
