...
const BaseInfoData = Mock.mock({
  ...
  'list|100': [
    {
      id: '@increment',
      'name|1': '管道类型' + '@integer(1,100)',
      belongToArea: '区域' + '@integer(1,100)',
      belongType: '管道类型' + '@integer(100,1000)',
      basicProperty2: '属性' + '@integer(1,100)',
      basicProperty1: '属性' + '@integer(1,100)',
      'ownProperty1|1': ['属性名称：管道用途,数据类型：字符型', '属性名称：管道长度，数据类型：数值型', '属性名称：管道直径，数据类型：字符型'],
      'ownProperty2|1': ['属性名称：管道包含线缆类型,数据类型：字符型', '属性名称：管道制材，数据类型：字符型', '属性名称：管道规格，数据类型：字符型'],
      image: Mock.Random.image('120x80', '@color()', '#FFF', '管道' + '@integer(1,100)'),
      createName: '@cname',
      createTime: '@datetime',
    },
  ],
