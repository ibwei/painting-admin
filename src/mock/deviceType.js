  ...
  'list|100': [
    {
      ...
      basicProperty2: '基础属性' + '@integer(1,100)',
      basicProperty1: '基础属性' + '@integer(1,100)',
      'ownProperty1|1': ['属性名称：设备用途,数据类型：字符型', '属性名称：设备功率，数据类型：数值型', '属性名称：设备电压，数据类型：字符型'],
      'ownProperty2|1': ['属性名称：设备制材,数据类型：字符型', '属性名称：设备气压，数据类型：数值型', '属性名称：设备规格，数据类型：字符型'],
