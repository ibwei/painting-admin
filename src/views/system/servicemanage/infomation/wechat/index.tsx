...
export default class Message extends Vue {
  ...
  render() {
    return (
      <a-card title='微信公众号服务管理' class='bjq'>
        <quill-editor
