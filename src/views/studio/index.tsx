...
import {Tag, Modal, Button, Table, Row, Col, Card, Input, Switch} from 'ant-design-vue';
import './index.less';
//@ts-ignore
...
export default class Studio extends Vue {
  ...
  statusChange(e: any) {
    console.log(e);
    this.paintingInfo.status = e ? 1 : 0;
    this.update();
  }
        ...
        <a-row>
          <a-col span='12' class='area'>
            <a-card hoverable bodyStyle={{height: '400px'}} title='画室基础信息'>
              <span
                class={this.pageStatus === 'edit' ? 'edit' : 'read'}
                slot='extra'
              ...
              <a-row>
                <a-col span='11'>
                  <div class='form-item'>
                    ...
                    <a-input
                      value={this.paintingInfo.name}
                      onChange={this.changeInfo.bind(this, 'name')}
                      style={{
                        border: this.pageStatus === 'edit' ? '' : 'none',
                        background: 'transparent',
                      }}
                      disabled={this.pageStatus === 'edit' ? false : true}
                      placeholder='请输入画室名称'
                    />
                  </div>
                </a-col>
                <a-col span='11' offset='2'>
                  <div class='form-item'>
                    ...
                    <a-input
                      value={this.paintingInfo.phone}
                      onChange={this.changeInfo.bind(this, 'phone')}
                      style={{
                        border: this.pageStatus === 'edit' ? '' : 'none',
                        background: 'transparent',
                      }}
                      disabled={this.pageStatus === 'edit' ? false : true}
                      placeholder='请输入画负责人电话号码'
                    />
                  </div>
                </a-col>
              </a-row>
              <a-row>
                <a-row>
                  ...
                  <a-col span='11' offset='2'>
                    <div class='form-item'>
                      ...
                      <a-input
                        value={this.paintingInfo.address}
                ...
                <a-row>
                  <a-col span='11'>
                    <div class='form-item'>
                      ...
                      <a-input
                        value={this.paintingInfo.qq}
                        onChange={this.changeInfo.bind(this, 'qq')}
                        style={{
                          border: this.pageStatus === 'edit' ? '' : 'none',
                          background: 'transparent',
                        }}
                        disabled={this.pageStatus === 'edit' ? false : true}
                        placeholder='官网接待聊天的QQ号'
                      />
                    </div>
                  </a-col>
                  <a-col span='11' offset='2'>
                    <div class='form-item'>
                      ...
                      <a-input
                        value={this.paintingInfo.wechat}
                        onChange={this.changeInfo.bind(this, 'wechat')}
                        style={{
                          border: this.pageStatus === 'edit' ? '' : 'none',
                          background: 'transparent',
                        }}
                        disabled={this.pageStatus === 'edit' ? false : true}
                        placeholder='请输入画室电子邮箱'
                      />
                    </div>
                  </a-col>
                </a-row>
                <a-row class='upload'>
                  <a-col class='upload-item' span='11'>
                    <div class='form-item'>
                      ...
                      {this.paintingInfo.er_code ? (
                        <img class='img-item' src={this.paintingInfo.er_code}></img>
                      ) : (
                        ''
                      )}
                      ...
                      {this.pageStatus === 'edit' ? (
                        <div class='image-upload'>
                          <upload-image
                            on-uploaded={this.changeImage.bind(this, 'er_code')}
                            placeholder='更改二维码'
                          />
                        </div>
                      ) : (
                  ...
                  <a-col class='upload-item' span='11' offset='2'>
                    <div class='form-item'>
                      ...
                      {this.paintingInfo.logo ? (
                        <img class='img-item' src={this.paintingInfo.logo}></img>
                      ) : (
                        ''
                      )}
                      ...
                      {this.pageStatus === 'edit' ? (
                        <div class='image-upload'>
                          <upload-image
                            on-uploaded={this.changeImage.bind(this, 'logo')}
                            placeholder='更改logo'
                          />
                        </div>
                      ) : (
                ...
                {this.pageStatus === 'edit' ? (
                  <a-row class='button-group'>
                    <a-button type='primary' onClick={this.update} style={{marginRight: '20px'}}>
                      提交
                    </a-button>
              ...
              <a-row>
                <div class='form-item'>
                  <div class='' style='margin:20px;font-weight:bold;'>
                    是否进入审核模式(开启之后无法看到招生简介/学生成果/美团提示等模块):
                  </div>
                  <a-switch
                    checked={Boolean(this.paintingInfo.status)}
          ...
          <a-col span='12' class='area'>
            <a-card hoverable title='画室地理位置'>
              <div slot='extra'>
                <span
                  class={this.mapStatus === 'edit' ? 'edit' : 'read'}
                  onClick={this.changeMapStatus}
                >
                  {this.mapStatus === 'read' ? '编辑地理位置' : '正在选择地址...'}
                </span>
                {this.mapStatus === 'edit' ? (
                  <span class='sure' onClick={this.update}>
                    确定
                  </span>
                ) : (
                  ''
